...
class ParamContainer(object):
    @staticmethod
    def InitContainer(container, **kwargs):
        ignores = ('self',)
...
class VisParamContainer(object):
    def __init__(self, vis='', field='', spw='', timerange='', uvrange='',
        ...
        Constructor
        """
        ParamContainer.InitContainer(self, **locals())
...
class ImageParamContainer(object):
    """
        ...
        if not hasattr(self, '_uvgridconfig'):
            ...
            UVGridConfig = collections.namedtuple('UVGridCondig', 
                                                  ['cellu', 'cellv',
                                                   'nu', 'nv',
                                                   'offsetu', 'offsetv'])
            self._uvgridconfig = UVGridConfig(cellu=cellu,
                                              cellv=cellv,
                                              nu=nu,
                                              nv=nv,
                                              offsetu=offsetu,
...
class GridParamContainer(object):
