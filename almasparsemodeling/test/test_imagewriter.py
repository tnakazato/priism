...
class ImageWriterTest(utils.TestBase):
    ...
    def _run_test(self, imageparam, arr, imagemeta=None):
        ...
        writer = core.imagewriter.ImageWriter(imageparam,
                                         arr,
                                         imagemeta) 
        
        if imagemeta is None:
            # default image metadata
            imagemeta = core.ImageMetaInfoContainer()
        ...
        try:
            ...
            phasecenter_rec = core.imagewriter.parse_phasecenter(imageparam.phasecenter)
    ...
    def test_custom_meta(self):
        ...
        # custom imagemeta
        imagemeta = core.ImageMetaInfoContainer(observer='Takeshi Nakazato',
                                           telescope='NRO',
    ...
    def test_coordsys(self):
        ...
        imparam = core.ParamContainer.CreateContainer(core.ImageParamContainer, **paramdict) 
        ...
        writer = core.imagewriter.ImageWriter(imageparam=imparam, imagearray=imarray)
        csys = writer._setup_coordsys()
        self.result = csys
        
    def test_phasecenter(self):
        phasecenter_str = '15:30:0 -10.30.00 J2000'
        phasecenter_rec = core.imagewriter.parse_phasecenter(phasecenter_str)
